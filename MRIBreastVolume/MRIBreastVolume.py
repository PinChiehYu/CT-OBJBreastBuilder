...
class MRIBreastVolumeWidget(ScriptedLoadableModuleWidget):
    ...
    def setup(self):
        ...
        self.estimateButton.setFont(qt.QFont("Times", 20, qt.QFont.Black))
        parametersFormLayout.addRow(self.estimateButton)
        ...
        parametersFormLayout.addRow("Segmentation : ", self.segmentSelector)
    ...
    def onEstimateButton(self):
        ...
        logic.Run(self.inputSelector.currentNode(), None, None, self.pectoralSmoothingIterationSpinBox.value)
...
class MRIBreastVolumeLogic(ScriptedLoadableModuleLogic):
    ...
    def Run(self, inputVolume, ROI=None, initPoint=None, pectoralSmoothingIterations=4000):
        ...
        orientedImage = self.sitkImageToVtkOrientedImage(result)
